...
import { View, Text, ImageBackground, Button, StyleSheet, ScrollView, TouchableOpacity } from 'react-native';
import Fundo from '/imagens/fundoverde.jpg';

const Card = ({ title, image }) => (
  <View style={styles.card}>
    <TouchableOpacity activeOpacity={0.8} style={styles.overlay}>
