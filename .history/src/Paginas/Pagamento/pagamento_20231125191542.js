...
export default function pagamento() {
  const [coupon, setCoupon] = useState(''); // Estado para o cupom de desconto
      ...
      <ImageBackground source={Fundo} style={styles.image}>
        ...
        <View style={styles.card}>
          <View style={styles.column}>
            ...
            <Text style={styles.cardText}>Local de entrega do veículo</Text>
            ...
            <Text style={styles.cardText}>Você tem um cupom: {coupon ? 'Sim' : 'Não'}</Text>
