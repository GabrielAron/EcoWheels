...
export default function Home() {
  ...
  const pickupLocations = ['Aeroporto Internacional de Guarulhos (GRU), São Paulo, SP', 'Aeroporto Santos Dumont (SDU), Rio de Janeiro, RJ', 'Rodoviária Novo Rio, Rio de Janeiro, RJ', 'Opção 4', 'Opção 5'];
