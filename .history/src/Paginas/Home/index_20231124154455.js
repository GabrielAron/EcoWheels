...
import { View, Text, TextInput, Button, StyleSheet, ImageBackground, Alert } from 'react-native'; // Import Alert from react-native
    ...
    <ImageBackground source={Fundo} style={styles.image}>
      <View style={styles.container}>
        ...
        <View style={styles.formContainer}>
          ...
          <TextInput style={styles.input} placeholder="Data de retirada" keyboardType="numeric" value={pickupDate} onChangeText={handleDateChange} />
