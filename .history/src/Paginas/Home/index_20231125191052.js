...
export default function Home() {
  ...
  const pickupLocations = ['Aeroporto Internacional de Guarulhos (GRU), São Paulo, SP', 'Aeroporto Santos Dumont (SDU), Rio de Janeiro, RJ', 'Rodoviária Novo Rio, Rio de Janeiro, RJ', 'Aeroporto de Congonhas (CGH), São Paulo, SP', 'Aeroporto Internacional de Brasília (BSB), Brasília, DF'];
  const dropoffLocations = ['Aeroporto Internacional de Guarulhos (GRU), São Paulo, SP', 'Aeroporto Santos Dumont (SDU), Rio de Janeiro, RJ', 'Rodoviária Novo Rio, Rio de Janeiro, RJ', 'Aeroporto de Congonhas (CGH), São Paulo, SP', 'Aeroporto Internacional de Brasília (BSB), Brasília, DF'];
      ...
      <View style={styles.container}>
        ...
        >
          {dropoffLocations.map((location, index) => (
            ...
            <TextInput style={styles.input} placeholder="20Wheels" onChangeText={(text) => setCoupon(text)} />
