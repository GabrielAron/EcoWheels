...
export default function Home() {
  ...
  const pickupLocations = ['Aeroporto Internacional de Guarulhos (GRU), São Paulo, SP', 'Aeroporto Santos Dumont (SDU), Rio de Janeiro, RJ', 'Rodoviária Novo Rio, Rio de Janeiro, RJ', 'Aeroporto de Congonhas (CGH), São Paulo, SP', 'Opção 5'];
