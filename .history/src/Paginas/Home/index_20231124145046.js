    ...
    <ImageBackground source={Fundo} style={styles.image}>
      <View style={styles.container}>
        ...
        <View style={styles.formContainer}>
          ...
          <TextInput style={styles.input} placeholder="Data de retirada" keyboardType="numeric" />
          <TextInput style={styles.input} placeholder="Data de entrega" keyboardType="numeric" />
